...
#
#     PHX_SERVER=true bin/crypto_tracker start
#
...
if config_env() == :prod do
  ...
  config :crypto_tracker, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :crypto_tracker, CryptoTracker.Mailer,
