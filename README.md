...
- [x] Configured `runtime.exs` to load env variables in production
...
- [ ] Consider an in-memory cache (ETS or `:persistent_term`) for fast price reads
...
- [ ] Optional: add logging/alerts for repeated GenServer crashes or failed fetches
